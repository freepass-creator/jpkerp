  ...
  gridApi = agGrid.createGrid($('#insuranceGrid'), {
    columnDefs: [
      ...
      { headerName: '회원사코드', field: 'partner_code', width: 90, pinned: 'left',
        cellStyle: p => p.value ? { color: 'var(--c-primary)', fontWeight: 700, textAlign: 'center' } : { color: 'var(--c-text-muted)', textAlign: 'center' },
        valueFormatter: p => p.value || '미등록' },
      { headerName: '회원사명', field: 'member_name', width: 140, pinned: 'left' },
      { headerName: '차량번호', field: 'car_number', width: 100, pinned: 'left', cellStyle: { fontWeight: 600 } },
      { headerName: '차대번호', field: 'vin', width: 160 },
      { headerName: '차량', field: '_car_info', width: 130 },
      { headerName: '보험사', field: 'insurance_company', width: 110 },
      { headerName: '증권번호', field: 'policy_no', width: 150 },
      { headerName: '상품명', field: 'insurance_product', width: 180 },
      { headerName: '유형', field: 'insurance_type', width: 70 },
      { headerName: '시작일', field: 'insurance_start', width: 95 },
      { headerName: '만료일', field: 'insurance_end', width: 95 },
      { headerName: '피보험자', field: 'insured_name', width: 130 },
      { headerName: '사업자번호', field: 'insured_biz_no', width: 120 },
      { headerName: '대인Ⅰ', field: 'coverage_liability_1', width: 140, cellStyle: { fontWeight: 600 } },
      { headerName: '대인Ⅱ', field: 'coverage_liability_2', width: 90, cellStyle: { fontWeight: 600 } },
      { headerName: '대물', field: 'coverage_property', width: 110, cellStyle: { fontWeight: 600 } },
      { headerName: '자손', field: 'coverage_self_injury', width: 140 },
      { headerName: '무보험', field: 'coverage_uninsured', width: 100 },
      { headerName: '자차', field: 'coverage_self_damage', width: 80,
        valueFormatter: p => p.value || '미가입',
        cellStyle: p => !p.value || /미가입/.test(p.value) ? { color: 'var(--c-danger)' } : { fontWeight: 600 } },
      { headerName: '총보험료', field: 'total_premium', width: 100, type: 'numericColumn', valueFormatter: fmtNum, cellStyle: { fontWeight: 700 } },
      { headerName: '납입액', field: 'paid_amount', width: 90, type: 'numericColumn', valueFormatter: fmtNum },
      { headerName: '납입방법', field: 'payment_method', width: 100 },
      { headerName: '분납', field: 'installment_count', width: 55, type: 'numericColumn', valueFormatter: p => p.value ? `${p.value}회` : '' },
      { headerName: '운전범위', field: 'driver_range', width: 90 },
      { headerName: '연령한정', field: 'age_limit', width: 100 },
      { headerName: '할증금액', field: 'deductible_amount', width: 90, type: 'numericColumn', valueFormatter: fmtNum },
      { headerName: '차명', field: 'car_model', width: 120 },
      { headerName: '연식', field: 'car_year', width: 55 },
      { headerName: '차량가액', field: 'car_value', width: 90, type: 'numericColumn', valueFormatter: fmtNum },
      { headerName: '부속가액', field: 'accessory_value', width: 80, type: 'numericColumn',
        valueFormatter: p => p.value ? fmtNum(p) : '없음',
        cellStyle: p => !p.value ? { color: 'var(--c-text-muted)' } : {} },
      { headerName: '특약', field: 'special_terms', width: 250, valueFormatter: fmtTerms, tooltipValueGetter: fmtTerms },
      { headerName: '메모', field: 'note', flex: 1, minWidth: 160 },
      ...instColumns,
    ],
    rowData: [],
