 ...
 *
 * 섹션: 차량 → 스펙 → 제원 → 등록 → 취득 → 취득비용 → 할부실행 → 소유 → 차키 → GPS → 기타
 */

export const ASSET_SCHEMA = [
  // ── 회원사 ──
  { col: 'partner_code', label: '회원사코드', section: '차량', sample: 'MEM001' },
  // ── 차량 기본 ──
  { col: 'car_number',   label: '차량번호',   section: '차량', required: true, gridShow: true, sample: '123가4567' },
  { col: 'vin',          label: '차대번호',   section: '차량', required: true, gridShow: true, sample: 'KMHD341DBNU123456' },
  { col: 'manufacturer', label: '제조사',     section: '차량', gridShow: true, sample: '현대' },
  { col: 'car_model',    label: '모델명',     section: '차량', gridShow: true, sample: '아반떼' },
  { col: 'detail_model', label: '세부모델',   section: '차량', sample: 'CN7' },
  { col: 'car_year',     label: '연식',       section: '차량', type: 'number', gridShow: true, num: true, sample: '2024' },
  { col: 'asset_status', label: '상태',      section: '차량', type: 'select', options: ['가동중','상품대기','상품화중','정비중','매각예정','폐차'], gridShow: true, sample: '가동중' },

  // ── 스펙 ──
  { col: 'trim',         label: '트림',       section: '스펙', sample: '스마트' },
  { col: 'options',      label: '선택옵션',   section: '스펙', sample: '선루프,네비' },
  { col: 'ext_color',    label: '외부색상',   section: '스펙', sample: '화이트' },
  { col: 'int_color',    label: '내부색상',   section: '스펙', sample: '블랙' },
  { col: 'consumer_price',label: '소비자가격', section: '스펙', type: 'number', num: true, sample: '25000000' },
  { col: 'vehicle_price',label: '차량가격',   section: '스펙', type: 'number', num: true, sample: '23000000' },

  // ── 제원 ──
  { col: 'fuel_type',    label: '연료',       section: '제원', type: 'select', options: ['가솔린','디젤','LPG','하이브리드','전기'], sample: '가솔린' },
  ...
  // ── 등록 ──
  { col: 'first_reg_date',  label: '최초등록일',  section: '등록', type: 'date', gridShow: true, sample: '2024-03-15' },
  ...
  // ── 취득 ──
  { col: 'purchase_method', label: '취득방법',  section: '취득', type: 'select', options: ['할부','리스','현금','인수','위탁'], gridShow: true, sample: '할부' },
  { col: 'purchase_date',   label: '취득일',    section: '취득', type: 'date', gridShow: true, sample: '2024-03-10' },
  { col: 'dealer',          label: '매입처',    section: '취득', sample: '현대오토' },
  { col: 'purchase_price',  label: '취득원가',  section: '취득', type: 'number', num: true, gridShow: true, sample: '22000000' },
  ...
  // ── 기타 ──
  { col: 'mileage', label: '주행거리', section: '기타', type: 'number', num: true, sample: '15000' },
  { col: 'note',    label: '비고',     section: '기타', type: 'textarea' },
];

export const ASSET_SECTIONS = ['차량', '스펙', '제원', '등록', '취득', '취득비용', '할부실행', '소유', '차키', 'GPS', '기타'];
